...
export default function Card(props) {
    return(
        <div className="border-b-2 p-6 m-4 w-auto flex flex-col vertical-middle sm:flex-row sm:w-10/12 sm:m-auto md:w-9/12">
            <div className="sm:w-1/2">
                <img src={props.imageUrl} className="rounded-2xl w-full sm:w-11/12"/>
            </div>
            <div className="sm:w-1/2">
